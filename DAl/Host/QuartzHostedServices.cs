...
namespace Part_2_Lesson_8.DAl.Host
{
    public class QuartzHostedServices : IHostedService//запуск зада по расписанию 
    {
        ...
        public QuartzHostedServices(IRepository<CpuDto> repositories, ISchedulerFactory factory, IJobFactory jobfactory, IEnumerable<JobSheldure> jobs)
        {
